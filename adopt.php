    ...
    <div class="container">
        ...
        <form action="" method="POST" class="adopt">
            ...
            <fieldset>
                ...
                <input type="text" name="full-name" placeholder="E.g. Md Ataullha" class="input-responsive" required>

                <div class="order-label">Phone Number</div>
                <input type="tel" name="contact" placeholder="E.g. +8801879093418" class="input-responsive" required>

                <div class="order-label">Email</div>
                <input type="email" name="email" placeholder="E.g. saimsaimsaimsaim7246@gmail.com" class="input-responsive" required>
